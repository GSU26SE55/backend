...
public class NotificationDispatchOptions
{
    ...
    // 02/08/2026 — bỏ DefaultLocale: template không còn locale nên không còn gì để chọn.
    ...
    public static readonly IReadOnlyDictionary<NotificationTypeEnum, NotificationChannelEnum[]> DefaultTypeChannelMatrix =
        new Dictionary<NotificationTypeEnum, NotificationChannelEnum[]>
        {
            ...
            [NotificationTypeEnum.PeriodicMaintenanceReminder] = [NotificationChannelEnum.InApp, NotificationChannelEnum.Push],
            [NotificationTypeEnum.PeriodicMaintenanceScheduleChanged] = [NotificationChannelEnum.InApp, NotificationChannelEnum.Push],
            ...
            // khớp nhau.
            [NotificationTypeEnum.BatteryAnomalyDetected] = [NotificationChannelEnum.InApp, NotificationChannelEnum.Push, NotificationChannelEnum.Email, NotificationChannelEnum.Sms],
            ...
            // Bổ sung 03/08/2026 — ba type dưới đây có consumer ghi thật (đều Channel=InApp) nhưng
            // trước nay vắng mặt ở ma trận, nên seeder không dựng template cho chúng và thông báo
            // gửi đi luôn dùng chuỗi hardcode. Khai vào đây là chúng có template như mọi type khác.
            [NotificationTypeEnum.TicketMerged] = [NotificationChannelEnum.InApp],
