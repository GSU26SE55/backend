...
public class OutboxRelayService : IOutboxRelayService
{
    ...
    private static readonly Dictionary<string, Type> EventTypeMap = new()
    {
        ...
        { nameof(TicketResolvedEvent), typeof(TicketResolvedEvent) },
        { nameof(IncidentDeclaredEvent), typeof(IncidentDeclaredEvent) },
        { nameof(TicketStatusChangedEvent), typeof(TicketStatusChangedEvent) },
        { nameof(TicketApprovedEvent), typeof(TicketApprovedEvent) },
        { nameof(TicketRejectedEvent), typeof(TicketRejectedEvent) },
        ...
        { nameof(PeriodicMaintenanceTicketRaisedEvent), typeof(PeriodicMaintenanceTicketRaisedEvent) },
