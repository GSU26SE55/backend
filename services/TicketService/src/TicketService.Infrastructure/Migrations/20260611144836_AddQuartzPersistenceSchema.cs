...
{
    /// <summary>
    /// Sprint 5B #235 — Quartz.NET PostgreSQL persistence schema (11 tables qrtz_*).
    /// Theo official Quartz.NET PostgreSQL SQL script:
    /// https://github.com/quartznet/quartznet/blob/main/database/tables/tables_postgres.sql
    ///
    /// Cluster mode: instanceId AUTO + clusterCheckinInterval 10000ms.
    /// Tables PHẢI tồn tại trước khi enable AlertTicketSaga persistent timeout (#237).
    /// </summary>
    public partial class AddQuartzPersistenceSchema : Migration
    {
        /// <inheritdoc />
...
CREATE INDEX idx_qrtz_ft_inst_job_req_rcvry ON qrtz_fired_triggers (instance_name, requests_recovery);
CREATE INDEX idx_qrtz_ft_j_g ON qrtz_fired_triggers (job_name, job_group);
CREATE INDEX idx_qrtz_ft_t_g ON qrtz_fired_triggers (trigger_name, trigger_group);
");
        }
