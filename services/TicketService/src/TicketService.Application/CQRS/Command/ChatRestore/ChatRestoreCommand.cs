...
namespace TicketService.Application.CQRS.Command.ChatRestore;

public class ChatRestoreCommand : IRequest<TicketActionResponse>, IValidatable<TicketActionResponse>
{
    /// <summary>
