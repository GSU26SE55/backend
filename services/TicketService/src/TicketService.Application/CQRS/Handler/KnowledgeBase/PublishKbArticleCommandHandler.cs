...
public class PublishKbArticleCommandHandler : IRequestHandler<PublishKbArticleCommand, CommonResponse<KbArticleDto>>
{
    ...
    public async Task<CommonResponse<KbArticleDto>> Handle(PublishKbArticleCommand command, CancellationToken ct)
    {
