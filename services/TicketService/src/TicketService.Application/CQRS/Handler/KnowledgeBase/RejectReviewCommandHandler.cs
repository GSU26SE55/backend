...
public class RejectReviewCommandHandler : IRequestHandler<RejectReviewCommand, CommonResponse<KbArticleDto>>
{
    ...
    public async Task<CommonResponse<KbArticleDto>> Handle(RejectReviewCommand command, CancellationToken ct)
    {
