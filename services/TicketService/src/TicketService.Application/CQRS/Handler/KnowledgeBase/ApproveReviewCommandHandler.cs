...
public class ApproveReviewCommandHandler : IRequestHandler<ApproveReviewCommand, CommonResponse<KbArticleDto>>
{
    ...
    public async Task<CommonResponse<KbArticleDto>> Handle(ApproveReviewCommand command, CancellationToken ct)
    {
