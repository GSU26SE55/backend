...
/// <summary>
/// Controller dành cho Staff (và Manager/Admin) để soạn thảo và quản lý nội dung bài viết Knowledge Base.
/// </summary>
[ApiController]
[Route("api/staff/knowledge-base")]
[Authorize(Roles = "Staff,Manager,Admin")]
[Produces("application/json")]
public class StaffKnowledgeBaseController : ControllerBase
{
    private readonly IMediator _mediator;
    private readonly ITicketCurrentUserService _currentUser;

    public StaffKnowledgeBaseController(IMediator mediator, ITicketCurrentUserService currentUser)
    {
        _mediator = mediator;
    ...
    /// <summary>
    /// Tạo mới một bài viết Knowledge Base ở trạng thái Nháp (Draft).
    /// </summary>
    /// <remarks>
    /// - Yêu cầu nhập đầy đủ tiêu đề, triệu chứng, các bước chẩn đoán và xử lý.
    /// - Mã bài viết (Code) được hệ thống tự động sinh theo định dạng KB-YYYY-NNNN.
    /// </remarks>
    ...
    [HttpPost]
    [ProducesResponseType(typeof(CommonResponse<KbArticleDto>), StatusCodes.Status201Created)]
