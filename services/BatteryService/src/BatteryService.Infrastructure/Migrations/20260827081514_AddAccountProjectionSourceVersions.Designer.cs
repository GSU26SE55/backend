...
namespace BatteryService.Infrastructure.Migrations
{
    ...
    [Migration("20260827081514_AddAccountProjectionSourceVersions")]
    partial class AddAccountProjectionSourceVersions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BatteryService.Domain.Entities.Alert", b =>
                {
                    ...
                    b.Property<string>("AiPrescriptionId")
                        .HasMaxLength(64)
            ...
            modelBuilder.Entity("BatteryService.Domain.Entities.AnomalyClassification", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.Property<int?>("StaffFeedback")
                        .HasColumnType("integer")
                        .HasColumnName("staff_feedback");

                    b.Property<DateTime?>("StaffFeedbackAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("staff_feedback_at");

                    b.Property<Guid?>("StaffFeedbackByUserId")
                        .HasColumnType("uuid")
                        .HasColumnName("staff_feedback_by_user_id");
                    ...
                    b.HasIndex("AlertId")
                        .HasDatabaseName("ix_anomaly_classifications_alert_id");

                    b.HasIndex("BatteryAssetId", "ClassifiedAt")
                        .HasDatabaseName("ix_anomaly_classifications_asset_classified_at");

                    b.ToTable("anomaly_classifications", (string)null);
                });
            ...
            modelBuilder.Entity("BatteryService.Domain.Entities.BatteryAuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("EventId")
                        .IsUnique()
                        .HasDatabaseName("ux_battery_audit_logs_event_id");

                    b.HasIndex("ActionCode", "CreatedAt")
                        .HasDatabaseName("ix_battery_audit_logs_action");

                    b.HasIndex("TargetId", "CreatedAt")
                        .HasDatabaseName("ix_battery_audit_logs_target");

                    b.ToTable("battery_audit_logs", (string)null);
                });

            modelBuilder.Entity("BatteryService.Domain.Entities.BatteryAuditOutbox", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("EventId")
                        .IsUnique()
                        .HasDatabaseName("ux_battery_audit_outbox_event_id");

                    b.HasIndex("Status", "CreatedAt")
                        .HasDatabaseName("ix_battery_audit_outbox_pending")
                        .HasFilter("status = 1");

                    b.ToTable("battery_audit_outbox", (string)null);
                });
            ...
            modelBuilder.Entity("BatteryService.Domain.Entities.IotDevice", b =>
                {
                    ...
                    b.Property<string>("ApiKeyPlaintext")
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)")
            ...
            modelBuilder.Entity("BatteryService.Domain.Entities.IotDeviceCommand", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");

                    b.Property<string>("AckError")
                        .HasMaxLength(512)
                        .HasColumnType("character varying(512)")
            ...
            modelBuilder.Entity("BatteryService.Domain.Entities.SohPrediction", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.Property<DateTime>("InputWindowEndUtc")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("input_window_end_utc");

                    b.Property<DateTime>("InputWindowStartUtc")
                        .HasColumnType("timestamp with time zone")
                    ...
                    b.Property<decimal>("PredictedSohPercent")
                        .HasPrecision(5, 2)
                        .HasColumnType("numeric(5,2)")
                        .HasColumnName("predicted_soh_percent");
                    ...
                    b.HasIndex("BatteryAssetId", "PredictedAt")
                        .IsDescending(false, true)
                        .HasDatabaseName("ix_soh_predictions_asset_predicted_at");

                    b.ToTable("soh_predictions", (string)null);
                });
            ...
            modelBuilder.Entity("BatteryService.Domain.Entities.AnomalyClassification", b =>
                {
                    b.HasOne("BatteryService.Domain.Entities.Alert", "Alert")
                        .WithMany()
