...
namespace SmsService.Infrastructure.Migrations
{
    ...
    [Migration("20260804165906_AddOutboxLeaseClaim")]
    partial class AddOutboxLeaseClaim
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmsService.Domain.Entities.SmsAuditOutbox", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("EventId")
                        .IsUnique()
                        .HasDatabaseName("ux_sms_audit_outbox_event_id");

                    b.HasIndex("Status", "CreatedAt")
                        .HasDatabaseName("ix_sms_audit_outbox_pending")
                        .HasFilter("status = 1");

                    b.ToTable("sms_audit_outbox", (string)null);
                });
