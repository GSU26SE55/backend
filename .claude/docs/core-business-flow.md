...
flowchart LR
    ...
    Start --> P1{P1 Critical<br/>1 ngày}
...
flowchart TD
    ...
    SR1 --> SR2[P1: 1 ngày → Staff Tier 1<br/>P2: 3 ngày → Staff Tier 2<br/>P3: 7 ngày → Staff Tier 3]
...
|----------|-----|---------|------------|---------------|
| P1 Critical | 1 ngày (10h làm việc) | Rủi ro an toàn, mất điện, nguy cơ hư hại | Tier 1 (tổng thể) | Manager reassign Senior + notify Admin → Critical Incident nếu vẫn fail |
...
| P3 Normal | 7 ngày (70h làm việc) | Bất thường nhẹ, câu hỏi vận hành | Tier 3 (chuyên sâu) | Escalate xử lý theo chuẩn P2 — Manager reassign senior |
