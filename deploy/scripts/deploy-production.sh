...
helm_value_args=(
  ...
  --set-string "config.Battery__MaintenanceSchedule__Enabled=${ticket_periodic_maintenance_enabled}"
  --set-string "config.Battery__MaintenanceSchedule__TimeZoneId=${ticket_periodic_maintenance_time_zone_id}"
  --set-string "config.Battery__MaintenanceSchedule__DefaultCycleMonths=${ticket_periodic_maintenance_cycle_months}"
  --set-string "config.Battery__MaintenanceSchedule__LeadDays=${ticket_periodic_maintenance_lead_days}"
  --set-string "config.Battery__MaintenanceSchedule__PollIntervalSeconds=${ticket_periodic_maintenance_poll_interval_seconds}"
  --set-string "config.Battery__MaintenanceSchedule__BatchSize=${ticket_periodic_maintenance_batch_size}"
